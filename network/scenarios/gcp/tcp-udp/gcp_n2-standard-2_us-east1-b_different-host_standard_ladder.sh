#!/usr/bin/env bash
# Intra-zone: two instances in us-east1-b, on different hosts.
#
...
SCENARIO_NAME=gcp_n2-standard-2_us-east1-b_different-host_standard_ladder
OS_TUNING=standard
...
SERVER_AVAILABILITY_ZONE=us-east1-b
