#!/usr/bin/env bash
# Intra-zone: two instances in us-east4-c, on different hosts.
#
...
SCENARIO_NAME=gcp_n2-standard-2_us-east4-c_different-host_standard_ladder
OS_TUNING=standard
...
SERVER_AVAILABILITY_ZONE=us-east4-c
